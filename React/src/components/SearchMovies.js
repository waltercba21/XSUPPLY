...
function SearchMovies() {
  ...
  const SearchMovies = async (e) => {
    e.preventDefault();
    const imputValue = imputTag.current.value;
    setKeyword(imputValue);
    imputTag.current.value = "";
  };
  // Credenciales de API
  const apiKey = "f4bc57df"; // Intenta poner cualquier cosa antes para probar
  return (
            ...
            <div className="col-12 col-md-6">
              ...
              <form method="GET" onSubmit={SearchMovies}>
                <div className="form-group">
                  ...
                  <input ref={imputTag} type="text" className="form-control" />
                </div>
